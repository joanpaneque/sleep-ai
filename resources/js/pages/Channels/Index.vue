...
const settingsChannel = (channelId) => {
    router.get(route('channels.settings', channelId));
}

const analyticsChannel = (channelId) => {
                        ...
                        <div class="px-6 pb-6">
                            <div class="flex items-center justify-between pt-4 border-t border-gray-700/50">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button
                                        @click.stop="settingsChannel(channel.id)"
                                        class="p-2.5 hover:bg-gray-700/50 rounded-xl transition-all duration-200 group/btn"
                                        title="Configuración del canal"
                                    >
                                        <svg class="w-4 h-4 text-gray-400 group-hover/btn:text-purple-400 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button
                                        @click.stop="analyticsChannel(channel.id)"
                                        class="p-2.5 hover:bg-gray-700/50 rounded-xl transition-all duration-200 group/btn"
                                        title="Analíticas del canal"
                                    >
                                        <svg class="w-4 h-4 text-gray-400 group-hover/btn:text-green-400 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
